...
namespace SmartArray_Test
{
    ...
    class SmartArray
    {
        ...
        //// Explanation (Why did you choose that running time?):
        /// the program at maxium checks 2 if statements and sets a vairable to a value
        /// no matter what the parameters are the programs the ammount of steps it takes is the same every time
        ...
        //// Running time for this method: O(N)
        //// Explanation (Why did you choose that running time?):
        /// this method is a linear search of an array which is almost the definition
