...
namespace PCE_StarterProject
{
    ...
    {
        /// a stack is a LIFO system (last in first out) when you push something on
        /// to a stack your are in a sense "Stacking" the item on top of eachother
        /// 
    ...
    class BasicGeneric<typeOfData>
    {
        ...
        public void SetItem(typeOfData i)
        {
            info = i;
        }
    ...
    public class AbsValComparer : IComparer<double>
    {
